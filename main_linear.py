...
RTSNet_Pipeline.setTrainingParams(n_Epochs=1, n_Batch=30, learningRate=1E-3, weightDecay=1E-9)
RTSNet_Pipeline.model = torch.load('RTSNet/best-model_linear2x2rq020T100.pt',map_location=dev)
